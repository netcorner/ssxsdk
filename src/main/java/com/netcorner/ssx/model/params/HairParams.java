...
public class HairParams {
        ...
        @ApiModelProperty(name = "Type", value = "类型 key(auto 汽车，hairdemand 理发，ecovery 加收，digit 数码,food 订餐,edu 教育)")
        private String type;
        /**
         * 得到 类型 key(auto 汽车，hairdemand 理发，ecovery 加收，digit 数码,food 订餐,edu 教育)
         * @return
         */
        ...
        /**
         * 设置 类型 key(auto 汽车，hairdemand 理发，ecovery 加收，digit 数码,food 订餐,edu 教育)
         * @param type
         */
