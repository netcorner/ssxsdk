 ...
 */
public class NewRentdemandParams {
        ...
        @ApiModelProperty(name = "ServiceWayID", value = "服务方式（如：上门、到店等）")
        private Integer serviceWayID;
        /**
         * 得到 服务方式（如：上门、到店等）
         * @return
         */
        public Integer getServiceWayID() {
                return serviceWayID;
        }
        /**
         * 设置 服务方式（如：上门、到店等）
         * @param serviceWayID
         */
        public void setServiceWayID(Integer serviceWayID) {
                this.serviceWayID = serviceWayID;
        }
    
                

        
        @ApiModelProperty(name = "ServiceWayName", value = "服务方式（如：上门、到店等）")
